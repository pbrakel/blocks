...
class TrainingAlgorithm(object):
    ...
    Parameters
    ----------
    extensions : list of TrainExtensions
        These extensions will be called after each training step and
        monitoring step

    """
    __metaclass__ = ABCMeta

    def __init__(self, extensions=None, monitoring_datasets=None):
        if extensions is None:
            extensions = []
        if monitoring_datasets is None:
            monitoring_datasets = {}
